...
В ближайшее время планирую заполнить проект тестами. Изменить валидацию и избавиться от повторяющегося кода в views.py и
serializers.py по едпоинтам favorite, shopping_cart и download_shopping_cart,
